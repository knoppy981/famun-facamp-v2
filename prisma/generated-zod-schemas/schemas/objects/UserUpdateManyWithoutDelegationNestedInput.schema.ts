...
const Schema: z.ZodType<Prisma.UserUpdateManyWithoutDelegationNestedInput> = z
  .object({
    create: z
      .union([
    ...
    updateMany: z
      .union([
        z.lazy(() => UserUpdateManyWithWhereWithoutDelegationInputObjectSchema),
        z
          .lazy(() => UserUpdateManyWithWhereWithoutDelegationInputObjectSchema)
          .array(),
      ])
      .optional(),
    deleteMany: z
...
export const UserUpdateManyWithoutDelegationNestedInputObjectSchema = Schema;
