...
const Schema: z.ZodType<Prisma.NestedEnumAdvisorRoleNullableWithAggregatesFilter> =
  z
    .object({
      equals: z
...
export const NestedEnumAdvisorRoleNullableWithAggregatesFilterObjectSchema =
  Schema;
