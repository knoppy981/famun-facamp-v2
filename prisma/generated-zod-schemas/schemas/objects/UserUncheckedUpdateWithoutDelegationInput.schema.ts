...
import { PasswordUncheckedUpdateOneWithoutUserNestedInputObjectSchema } from './PasswordUncheckedUpdateOneWithoutUserNestedInput.schema';
...
const Schema: z.ZodType<Prisma.UserUncheckedUpdateWithoutDelegationInput> = z
  .object({
    email: z
      .union([
        z.string(),
    ...
    updatedAt: z
      ...
      .optional(),
    password: z
      .lazy(() => PasswordUncheckedUpdateOneWithoutUserNestedInputObjectSchema)
      .optional(),
    payments: z
      .lazy(() => PaymentUncheckedUpdateManyWithoutUserNestedInputObjectSchema)
      .optional(),
    files: z
      .lazy(() => FileUncheckedUpdateManyWithoutUserNestedInputObjectSchema)
      .optional(),
  })
  .strict();

export const UserUncheckedUpdateWithoutDelegationInputObjectSchema = Schema;
