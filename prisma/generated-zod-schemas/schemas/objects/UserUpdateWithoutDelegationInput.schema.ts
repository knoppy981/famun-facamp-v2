...
const Schema: z.ZodType<Prisma.UserUpdateWithoutDelegationInput> = z
  .object({
    email: z
      .union([
        z.string(),
    ...
    payments: z
      ...
      .optional(),
    files: z
      .lazy(() => FileUpdateManyWithoutUserNestedInputObjectSchema)
      .optional(),
  })
  .strict();

export const UserUpdateWithoutDelegationInputObjectSchema = Schema;
