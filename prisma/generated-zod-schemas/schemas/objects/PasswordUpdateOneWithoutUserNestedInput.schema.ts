...
const Schema: z.ZodType<Prisma.PasswordUpdateOneWithoutUserNestedInput> = z
  .object({
    create: z
      .union([
    ...
    connectOrCreate: z
      ...
      .optional(),
    upsert: z.lazy(() => PasswordUpsertWithoutUserInputObjectSchema).optional(),
...
export const PasswordUpdateOneWithoutUserNestedInputObjectSchema = Schema;
