...
const Schema: z.ZodType<Prisma.UserUpdateManyWithWhereWithoutDelegationInput> =
  z
    .object({
...
export const UserUpdateManyWithWhereWithoutDelegationInputObjectSchema = Schema;
