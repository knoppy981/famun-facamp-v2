...
const Schema: z.ZodType<Prisma.PaymentUncheckedCreateWithoutDelegationInput> = z
  .object({
...
export const PaymentUncheckedCreateWithoutDelegationInputObjectSchema = Schema;
