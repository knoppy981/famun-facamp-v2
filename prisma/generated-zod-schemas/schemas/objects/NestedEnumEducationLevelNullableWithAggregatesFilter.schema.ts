...
const Schema: z.ZodType<Prisma.NestedEnumEducationLevelNullableWithAggregatesFilter> =
  z
    .object({
      equals: z
...
export const NestedEnumEducationLevelNullableWithAggregatesFilterObjectSchema =
  Schema;
