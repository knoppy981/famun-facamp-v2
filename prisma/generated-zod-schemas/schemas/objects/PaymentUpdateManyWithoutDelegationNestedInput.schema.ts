...
const Schema: z.ZodType<Prisma.PaymentUpdateManyWithoutDelegationNestedInput> =
  z
    .object({
      create: z
        .union([
...
export const PaymentUpdateManyWithoutDelegationNestedInputObjectSchema = Schema;
