...
import { PasswordUncheckedCreateNestedOneWithoutUserInputObjectSchema } from './PasswordUncheckedCreateNestedOneWithoutUserInput.schema';
...
const Schema: z.ZodType<Prisma.UserUncheckedCreateWithoutDelegationInput> = z
  .object({
    ...
    password: z
      .lazy(() => PasswordUncheckedCreateNestedOneWithoutUserInputObjectSchema)
      .optional(),
    payments: z
...
export const UserUncheckedCreateWithoutDelegationInputObjectSchema = Schema;
