...
const Schema: z.ZodType<Prisma.DelegationUncheckedUpdateWithoutPaymentsInput> =
  z
    .object({
      code: z
        .union([
...
export const DelegationUncheckedUpdateWithoutPaymentsInputObjectSchema = Schema;
