...
import { PasswordCreateNestedOneWithoutUserInputObjectSchema } from './PasswordCreateNestedOneWithoutUserInput.schema';
...
import { DelegationCreateNestedOneWithoutUsersInputObjectSchema } from './DelegationCreateNestedOneWithoutUsersInput.schema';
...
const Schema: z.ZodType<Prisma.UserCreateInput> = z
  .object({
    ...
    password: z
      .lazy(() => PasswordCreateNestedOneWithoutUserInputObjectSchema)
      .optional(),
    payments: z
      .lazy(() => PaymentCreateNestedManyWithoutUserInputObjectSchema)
      .optional(),
    files: z
      .lazy(() => FileCreateNestedManyWithoutUserInputObjectSchema)
      .optional(),
    delegation: z.lazy(
      () => DelegationCreateNestedOneWithoutUsersInputObjectSchema,
    ),
  })
  .strict();
