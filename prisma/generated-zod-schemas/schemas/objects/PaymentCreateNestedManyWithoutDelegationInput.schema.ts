...
const Schema: z.ZodType<Prisma.PaymentCreateNestedManyWithoutDelegationInput> =
  z
    .object({
      create: z
        .union([
...
export const PaymentCreateNestedManyWithoutDelegationInputObjectSchema = Schema;
