...
const Schema: z.ZodType<Prisma.UserUncheckedCreateNestedManyWithoutDelegationInput> =
  z
    .object({
      create: z
        .union([
...
export const UserUncheckedCreateNestedManyWithoutDelegationInputObjectSchema =
  Schema;
