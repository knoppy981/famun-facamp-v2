...
import { NestedEnumDietNullableWithAggregatesFilterObjectSchema } from './NestedEnumDietNullableWithAggregatesFilter.schema';
import { NestedIntNullableFilterObjectSchema } from './NestedIntNullableFilter.schema';
import { NestedEnumDietNullableFilterObjectSchema } from './NestedEnumDietNullableFilter.schema';

import type { Prisma } from '@prisma/client';

const Schema: z.ZodType<Prisma.EnumDietNullableWithAggregatesFilter> = z
  .object({
    equals: z
      .lazy(() => DietSchema)
      .optional()
...
export const EnumDietNullableWithAggregatesFilterObjectSchema = Schema;
